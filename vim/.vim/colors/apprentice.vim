...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  if ($TERM_PROGRAM == 'iTerm.app')
    ...
    hi LineNr         ctermbg=NONE  ctermfg=250  guibg=#1c1c1c guifg=#6c6c6c cterm=NONE           gui=NONE
  ...
  hi Keyword          ctermbg=NONE ctermfg=110  guibg=NONE    guifg=#8fafd7 cterm=bold           gui=NONE
  ...
  hi VertSplit        ctermbg=NONE  ctermfg=238  guibg=#444444 guifg=#444444 cterm=NONE           gui=NONE
